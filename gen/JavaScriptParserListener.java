...
public interface JavaScriptParserListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterComma(JavaScriptParser.CommaContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaScriptParser#comma}.
	 * @param ctx the parse tree
	 */
	void exitComma(JavaScriptParser.CommaContext ctx);
}